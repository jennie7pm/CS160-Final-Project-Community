...
import { showDataAlgo, showInternSearch, showSampleResume } from "../../feature/resources-body/resourcesbodySlice.js";
...
export function Resources(){
    ...
    let sideMenuRowArr = [['Data Structure and Algorithms', DataAlgoIcon, showDataAlgo], ['Internship Search', InternSearchIcon, showInternSearch], ['Sample Resumes', SampleResumeIcon, showSampleResume]];
    return (<>
